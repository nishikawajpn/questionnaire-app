...
function validate_form() {
  ...
  for (const $choice_input of $choice_inputs) {
    ...
    activateSubmitBtnByChoices($form, $inputtingChoices);
...
function activateSubmitBtnByChoices($form, $inputtingChoices) {

  const $submitBtn = $form.querySelector('[type="submit"]');

  if ($form.checkValidity() && $inputtingChoices.length >= 2) {
...
function echoChoicesFeedback($inputtingChoices) {
  ...
  choices_feedback = document.querySelector('.choices-invalid-feedback')
